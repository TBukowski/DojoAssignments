...
// If they ever win, return the number of quarters (ex: they had 50 remaining quarters and 
// won 90, so it should return 140).

// Return 0 if all the quarters were wasted.

// Bonus (Only If You Have Time):  Let the user pass the number they are willing to leave with
